...
export default function Home() {
  ...
  const businessAreas = [
    {
      title: "Manufacturing",
      description: "The blanket and acrylic yarn dyeing plant is the major line of manufacturing business portfolio of KK. Our factory is equipped with modern computerized and automated machines, as well as conventional technology machines.",
      image: "/placeholder.svg?height=200&width=400&text=Manufacturing"
    },
    {
      title: "Export",
      description: "The exporting department at KK PLC mainly focuses on the international operation of the company, aiming to promote Ethiopian Coffee, Pulse, Oil Seed, and Mining to overseas markets.",
      image: "/placeholder.svg?height=200&width=400&text=Export"
    },
    {
      title: "Real Estate",
      description: "Our company implements innovative solutions in the engineering, design, and strategy sectors with the potential to create aesthetically marvelous spaces.",
  ...
  const portfolioItems = [
    {
      title: "Manufacturing",
      description: "State-of-the-art manufacturing facilities producing high-quality goods.",
      icon: "🏭",
    ...
    {
      title: "Hospitality",
      description: "Luxury hotels and resorts providing world-class experiences.",
      icon: "🏨",
      tags: ["Tourism", "Service"]
    },
    {
      title: "Education",
      description: "Investing in the future through quality educational institutions.",
      icon: "🎓",
  ...
  return (
    <>
      ...
      {/* Hero */}
      <div className="">
        <section id="home-section" className="relative bg-gradient-to-r from-blue-700 to-green-600 text-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xl sm:text-2xl text-gray-200 max-w-xl">
              Empowering Ethiopian businesses with global trade solutions for coffee, textiles, and more.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="text-gray-900 border-white hover:bg-white/20">
                Contact Us
              </Button>
            </div>
          </div>
          <div className="hidden lg:block">
            <div className="relative w-full h-[500px]">
              <Image
                src={heroImage}
                alt="Collage of Ethiopian export products"
                layout="fill"
                objectFit="contain"
      ...
      <section  id="about-section" className="relative  text-black py-24">
        ...
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">About KK PLC</h1>
          <p className="text-xl max-w-3xl">
            KK PLC is the largest business entity in Ethiopia, established by the visionary Mr. Ketema Kebede over forty years ago. Our diverse portfolio spans manufacturing, export, and real estate, contributing significantly to Ethiopia's economic growth.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              For over four decades, KK PLC has been at the forefront of Ethiopian business, driving innovation and economic development. Founded by Mr. Ketema Kebede, our company has grown from humble beginnings to become the largest business entity in Ethiopia.
            </p>
            <p className="text-lg text-gray-700 mb-6">
              Our success is built on a foundation of visionary leadership, commitment to quality, and a deep understanding of both local and international markets. We continue to expand our reach and impact, always with an eye towards sustainable growth and community development.
            </p>
      ...
      <section className="bg-gray-100 py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Our Business Areas</h2>
      ...
      <section className="py-20 container mx-auto px-4 text-center">
        <h2 className="text-3xl font-bold mb-6">Join Us in Shaping Ethiopia's Future</h2>
        <p className="text-lg text-gray-700 mb-8 max-w-3xl mx-auto">
          At KK PLC, we're not just building a business; we're building a nation. Our commitment to excellence, innovation, and sustainable development continues to drive us forward. Join us as we work towards a brighter future for Ethiopia and beyond.
        </p>
        <Button className="bg-blue-600 hover:bg-blue-700 text-white">
          Contact Us
          <ArrowRight className="ml-2 h-4 w-4" />
        ...
        <section      id="portfolio-section" className="py-12 px-4 bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-center mb-8">Our Portfolio</h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          KK has become one of the prominent businesses in Ethiopia, successfully diversifying its operations across multiple sectors.
        </p>
        ...
        >
          ...
          {/* CTA Section */}
          <section   id="contact-section" className="py-12 px-4 bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto">
          ...
          <Card className="w-full">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <p className="text-sm">
                  Churchil Avenue around national theater<br />
                  Adjacent to the Commercial Bank of Ethiopia,<br />
                  Addis Ababa Branch.
                </p>
              </div>
              <div className="space-y-2">
              ...
              <div className="flex items-center space-x-4">
                ...
                <a href="mailto:info@kkplcethiopia.com" className="text-sm text-blue-600 hover:underline">
                  info@pamrisen.com
                </a>
              </div>
            </CardContent>
